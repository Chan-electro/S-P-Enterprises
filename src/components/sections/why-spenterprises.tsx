...
import { ShieldCheck, Layers, Globe, Settings } from "lucide-react";
...
export default function WhyYSPSpares() {
    return (
        <section className="py-24 bg-white">
            <div className="container mx-auto px-6">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <h2 className="text-3xl sm:text-4xl font-display font-black text-black uppercase mb-4">Why YSP Spares?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {features.map((feature, i) => (
                        <motion.div
                            key={i}
                            className={`${feature.colSpan} ${feature.bg} p-8 rounded-sm border border-neutral-200 relative group overflow-hidden`}
