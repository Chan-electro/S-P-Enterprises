                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-neutral-600 text-lg mb-6 leading-relaxed">
                                Established in 1995 under the visionary leadership of Mr. H.S. Shivanandaswamy, YSP Spares has evolved from a precision workshop into a premier manufacturer and stockist of heavy earthmoving equipment spares.
                            </p>
                            <p className="text-neutral-600 text-lg mb-6 leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            <div className="bg-white p-6 shadow-sm border border-neutral-100 rounded-sm">
                                ...
                                <h3 className="font-bold text-xl mb-2">YSP Spares</h3>
